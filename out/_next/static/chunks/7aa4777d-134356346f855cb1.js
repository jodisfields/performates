"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[220],{7847:function(e,t,i){i.d(t,{o:function(){return t4}});var n,r=i(8954),s=i(5723),a=i(9858),o=i(9703),l=i(6574);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new r.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e){for(var t=arguments.length,i=Array(t>1?t-1:0),n=1;n<t;n++)i[n-1]=arguments[n];h.logLevel<=a.in.ERROR&&h.error("Auth (".concat(s.Jn,"): ").concat(e),...i)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tA=new y(3e4,6e4);function tL(){let e=e8().___jsl;if(null==e?void 0:e.H){for(let t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}}let tD=null,tM=new y(5e3,15e3),tU={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},tF=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);async function tx(e){let t=await (tD=tD||new Promise((t,i)=>{var n,r,s;function a(){tL(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{tL(),i(f(e,"network-request-failed"))},timeout:tA.get()})}if(null===(r=null===(n=e8().gapi)||void 0===n?void 0:n.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else if(null===(s=e8().gapi)||void 0===s?void 0:s.load)a();else{let t=ey("iframefcb");return e8()[t]=()=>{gapi.load?a():i(f(e,"network-request-failed"))},eI("https://apis.google.com/js/api.js?onload=".concat(t)).catch(e=>i(e))}}).catch(e=>{throw tD=null,e})),i=e8().gapi;return m(i,e,"internal-error"),t.open({where:document.body,url:function(e){let t=e.config;m(t.authDomain,e,"auth-domain-config-required");let i=t.emulator?w(t,"emulator/auth/iframe"):"https://".concat(e.config.authDomain,"/").concat("__/auth/iframe"),n={apiKey:t.apiKey,appName:e.name,v:s.Jn},a=tF.get(e.config.apiHost);a&&(n.eid=a);let o=e._getFrameworks();return o.length&&(n.fw=o.join(",")),"".concat(i,"?").concat((0,r.xO)(n).slice(1))}(e),messageHandlersFilter:i.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:tU,dontclear:!0},t=>new Promise(async(i,n)=>{await t.restyle({setHideOnLeave:!1});let r=f(e,"network-request-failed"),s=e8().setTimeout(()=>{n(r)},tM.get());function a(){e8().clearTimeout(s),i(t)}t.ping(a).then(a,()=>{n(r)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
